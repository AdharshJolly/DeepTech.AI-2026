        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative bg-white/60 backdrop-blur-xl p-10 md:p-12 border border-white/80 rounded-[2.5rem] shadow-xl hover:shadow-[0_20px_50px_rgba(0,181,226,0.1)] transition-all duration-500 group overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <h3 className="text-3xl lg:text-4xl font-heading font-black text-ieee-black mb-4 group-hover:text-ieee-blue transition-colors">Distinguished Speakers</h3>
              ...
              <div>
                <Link href="/speakers" className="inline-flex items-center text-ieee-blue font-bold tracking-widest uppercase text-sm group-hover:text-ieee-orange transition-colors bg-white/80 px-6 py-3 rounded-full border border-ieee-gray/20 shadow-sm hover:shadow-md">
                  View All Speakers
          ...
          <div className="relative bg-ieee-black p-10 md:p-12 border border-ieee-gray/10 rounded-[2.5rem] shadow-xl hover:shadow-[0_20px_50px_rgba(0,181,226,0.15)] transition-all duration-500 group overflow-hidden">
              ...
              >
                {Array.from({ length: 30 }).map((_, i) => (
                  <div key={i} className="mb-2 whitespace-nowrap">
                    {`> INIT SEQUENCE ${Math.random().toString(36).substring(2, 8).toUpperCase()}`} &nbsp;&nbsp;&nbsp;&nbsp; {`> STATUS: ONLINE`}<br/>
                    {`> LOADING TRACK_0${(i % 3) + 1}... OK`} &nbsp;&nbsp;&nbsp;&nbsp; {`> KERNEL PANIC: FALSE`}<br/>
                    {`> SYNCING NEURAL_NET_${i}... SUCCESS`} &nbsp;&nbsp;&nbsp;&nbsp; {`> EXECUTE`}<br/>
                    <br/>
                  </div>
                ))}
              </motion.div>
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <h3 className="text-3xl lg:text-4xl font-heading font-black text-white mb-4 group-hover:text-ieee-cyan transition-colors">Conference Agenda</h3>
              ...
              <div>
                <Link href="/agenda" className="inline-flex items-center text-ieee-cyan font-bold tracking-widest uppercase text-sm group-hover:text-ieee-orange transition-colors bg-white/10 px-6 py-3 rounded-full border border-white/20 shadow-sm backdrop-blur-md hover:bg-white/20">
                  View Full Agenda
                  <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
