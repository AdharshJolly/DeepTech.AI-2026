      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-ieee-gray mt-6 max-w-2xl mx-auto leading-relaxed">
            Have questions about the summit, registration, or sponsorship opportunities? Our organizing committee is here to assist you.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          <div className="w-full lg:w-5/12 flex flex-col gap-6">
            ...
            <div className="bg-white p-8 rounded-3xl border border-ieee-gray/10 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden hover:-translate-y-1">
               ...
               <div className="flex items-start gap-5 relative z-10">
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-ieee-black mb-2">Summit Venue</h3>
                   <p className="text-ieee-gray leading-relaxed mb-4">
                     GE Healthcare JFWTC<br/>
                     Whitefield, Bengaluru<br/>
                     Karnataka 560066, India
                   </p>
                   <a href="#" className="inline-flex items-center text-sm font-bold tracking-widest text-ieee-cyan uppercase hover:text-ieee-orange transition-colors">
            ...
            <div className="bg-white p-8 rounded-3xl border border-ieee-gray/10 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden hover:-translate-y-1">
               ...
               <div className="flex items-start gap-5 relative z-10">
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-ieee-black mb-2">Email Inquiries</h3>
                   <p className="text-ieee-gray leading-relaxed">
                     hello@deeptech2026.ieee.org
                   </p>
                   <p className="text-sm text-ieee-gray/60 mt-1">We aim to reply within 24 hours.</p>
                 </div>
               </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-ieee-gray/10 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden hover:-translate-y-1">
               ...
               <div className="flex items-start gap-5 relative z-10">
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-ieee-black mb-2">Direct Phone</h3>
                   <p className="text-ieee-gray leading-relaxed">
                     +91 800 123 4567
                   </p>
                   <p className="text-sm text-ieee-gray/60 mt-1">Mon-Fri from 9am to 6pm IST.</p>
                 </div>
               </div>
            </div>
          ...
          <div className="w-full lg:w-7/12 relative flex">
            <div className="bg-white p-4 rounded-[2.5rem] border border-ieee-gray/10 shadow-2xl relative overflow-hidden w-full h-full min-h-[450px]">
               ...
               <div className="relative z-10 w-full h-full rounded-[2rem] overflow-hidden shadow-inner bg-ieee-gray/5">
                 <iframe 
