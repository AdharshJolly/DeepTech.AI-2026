      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          <div className="w-full lg:w-5/12 flex flex-col gap-6">
            {/* Location Card */}
            <div className="bg-white p-8 rounded-3xl border border-ieee-gray/10 shadow-lg group relative overflow-hidden">
            ...
            {/* Map Embed Card */}
            <div className="bg-white p-4 rounded-[2.5rem] border border-ieee-gray/10 shadow-lg overflow-hidden relative flex-1 min-h-80">
          ...
          <div className="w-full lg:w-7/12">
            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-ieee-gray/10 shadow-2xl relative overflow-hidden">
