...
export default function InnovationAlley() {
  ...
  return (
    <section id="innovation-alley" className="py-16 md:py-24 relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-heading font-black text-ieee-black tracking-tight mt-4 mb-6">
            Innovation Alley
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-white p-6 md:p-10 rounded-[2rem] md:rounded-4xl border border-ieee-gray/10 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold font-heading text-ieee-black mb-3 md:mb-4">
                {feature.title}
              </h3>
              <p className="text-ieee-gray leading-relaxed text-sm md:text-base">
                {feature.description}
              </p>
            </div>
          ))}
