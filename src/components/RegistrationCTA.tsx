...
import { ArrowRight, Ticket, Calendar, Zap } from 'lucide-react';
        ...
        <div className="relative bg-ieee-black rounded-[3rem] overflow-hidden shadow-2xl p-10 md:p-20 text-center border border-white/10 group">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-heading font-black text-white tracking-tight mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ieee-orange to-ieee-cyan">
                in the Future.
              </span>
            </h2>
            
            <p className="text-xl text-ieee-gray/80 max-w-2xl mx-auto leading-relaxed mb-12">
              Join 500+ leaders, innovators, and researchers in Bengaluru for three days of cutting-edge Physical AI exploration. 
            </p>

            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <button disabled className="group/btn relative inline-flex items-center justify-center px-10 py-5 font-bold text-ieee-black transition-all duration-300 bg-white rounded-full shadow-[0_0_40px_rgba(0,181,226,0.2)] uppercase tracking-widest text-sm disabled:opacity-50 disabled:cursor-not-allowed">
