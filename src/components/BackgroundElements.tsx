...
import { Cpu, Network, CircuitBoard, Hexagon, Share2, Activity } from 'lucide-react';

export default function BackgroundElements() {
  return (
    <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden bg-ieee-white">
      {/* Subtle Dot Grid Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(#75787B_1.5px,transparent_1.5px)] [background-size:40px_40px] opacity-[0.05]"></div>
      ...
      <div className="absolute top-[30%] right-[30%] opacity-[0.08]">
        <div className="w-4 h-4 border-2 border-ieee-orange rounded-full animate-ping" style={{ animationDuration: '4s' }}></div>
      </div>
      
      <div className="absolute bottom-[40%] left-[40%] opacity-[0.08]">
        <div className="text-ieee-blue text-4xl font-mono tracking-widest">+</div>
      </div>
