  ...
  return (
    <section className="relative h-[calc(100vh-80px)] min-h-150 flex items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none opacity-60">
        ...
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "radial-gradient(#00629B 1px, transparent 1px)", backgroundSize: "32px 32px" }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center h-full pb-8">
        ...
        <h1 className="text-6xl md:text-8xl lg:text-[7rem] font-heading font-black text-ieee-black tracking-tighter mb-4 leading-none select-none">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-ieee-blue to-ieee-cyan">
        ...
        >
          Bridging the gap between <span className="text-ieee-blue font-bold">digital intelligence</span> and <span className="text-ieee-blue font-bold">physical systems</span> through robotics, hardware, and industrial automation.
        </motion.p>
        ...
        >
          <div className="flex items-center text-ieee-black bg-white/60 px-6 py-3 md:px-8 md:py-4 rounded-full backdrop-blur-xl border border-white/80 text-sm font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default">
            <Calendar className="w-5 h-5 mr-3 text-ieee-orange" aria-hidden="true" />
            <span className="tracking-wide">30 OCT 2026</span>
          </div>
          <div className="flex items-center text-ieee-black bg-white/60 px-6 py-3 md:px-8 md:py-4 rounded-full backdrop-blur-xl border border-white/80 text-sm font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default">
            <MapPin className="w-5 h-5 mr-3 text-ieee-cyan" aria-hidden="true" />
        ...
        >
          ...
          >
            <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-ieee-blue/50 to-ieee-cyan/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
            <span className="relative flex items-center">
              Registrations Coming Soon
              <ArrowRight className="w-4 h-4 ml-3 opacity-50" aria-hidden="true" />
            </span>
          </button>
        </motion.div>
