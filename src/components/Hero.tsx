...
export default function Hero() {
  return (
    <section className="relative h-[calc(100vh-80px)] min-h-[600px] flex items-center justify-center overflow-hidden bg-transparent">
          ...
          <svg className="absolute w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="hero-grid" width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M 60 0 L 0 0 0 60" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-ieee-blue" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center h-full pb-8">
        ...
        >
          ...
          <span className="text-xs font-semibold tracking-widest text-ieee-blue uppercase">Physical AI Summit</span>
        </motion.div>
        ...
        >
          DeepTech<span className="text-transparent bg-clip-text bg-gradient-to-br from-ieee-blue to-ieee-cyan">.ai</span> 
          <span className="block mt-1 text-3xl md:text-5xl text-ieee-gray font-light tracking-tight">2026</span>
        </motion.h1>
        ...
        >
          Bridging the gap between <span className="text-ieee-blue font-semibold">digital intelligence</span> and <span className="text-ieee-blue font-semibold">physical systems</span> through robotics, hardware, and industrial automation.
        </motion.p>
        ...
        >
          ...
          <div className="flex items-center text-ieee-black bg-white/70 px-6 py-3 rounded-full backdrop-blur-md border border-ieee-gray/20 text-sm shadow-lg">
            ...
            <span className="font-semibold tracking-wide">GE Healthcare, Bengaluru</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-ieee-orange to-ieee-cyan opacity-20"></span>
