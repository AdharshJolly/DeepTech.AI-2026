...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center text-ieee-black relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-ieee-blue/10 rounded-full blur-[120px] opacity-70 pointer-events-none" />
      <div className="absolute top-1/4 left-1/4 w-100 h-100 bg-ieee-orange/10 rounded-full blur-[100px] opacity-60 pointer-events-none" />
      ...
      <div className="z-10 text-center flex flex-col items-center space-y-8 p-8 backdrop-blur-sm bg-white/60 rounded-3xl border border-ieee-gray/20 shadow-xl max-w-2xl w-full mx-4">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h1 className="text-7xl font-bold font-heading tracking-tighter bg-linear-to-r from-ieee-blue to-ieee-cyan bg-clip-text text-transparent">
            404
          </h1>
          ...
          <p className="text-ieee-gray max-w-md mx-auto text-sm leading-relaxed">
            The coordinates you requested do not exist in our current cognitive
            matrix. The AI core suggests recalibrating your navigation
            parameters.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 h-full w-full bg-linear-to-r from-ieee-orange to-ieee-orange/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </Link>
        </motion.div>
      </div>
    </div>
