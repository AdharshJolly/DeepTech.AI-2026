...
export default function SocialHubPage() {
  ...
  const quests = [
    {
      ...
      title: "The Announcer",
      points: 50,
      description: "Share the DeepTech.AI 2026 registration flyer on LinkedIn using #DeepTechAI2026.",
      actionText: "Share on LinkedIn",
      shareUrl: "https://www.linkedin.com/sharing/share-offsite/?url=https://deeptech.ai"
    },
    {
      id: "quest-2",
      title: "Network Builder",
      points: 70,
      description: "Tag 3 colleagues in our latest Instagram announcement post and invite them to the summit.",
    ...
    },
    {
      ...
      points: 100,
      description: "Post your excitement about attending or speaking at DeepTech.AI 2026 on X (formerly Twitter) with #DeepTechAI2026.",
      actionText: "Post on X",
      shareUrl: "https://twitter.com/intent/tweet?text=I'm%20excited%20to%20attend%20%23DeepTechAI2026!%20Join%20me%20for%20the%20flagship%20symposium.%20https://deeptech.ai"
    },
    {
      id: "quest-4",
      title: "Amplifier",
      points: 40,
      description: "Retweet/repost our latest keynote speaker announcement on X.",
      actionText: "Retweet on X",
      shareUrl: "https://twitter.com/ieeecsbs"
    }
  ];
  ...
  const handleQuestClaim = async (e: React.FormEvent) => {
    ...
    if (!email || !handle || !postUrl) {
      alert("Please fill in all form fields (Email, Social Handle, and Post Link)!");
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        setSubmitSuccess(`Claim submitted successfully! Points will appear on the leaderboard once verified by our team.`);
        setPostUrl("");
      ...
      <section className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-heading font-black text-ieee-black tracking-tight leading-none mb-6">
            DeepTech <span className="text-transparent bg-clip-text bg-linear-to-r from-ieee-blue to-ieee-cyan">Social Hub</span>
          </h1>
          <p className="text-lg text-ieee-gray leading-relaxed font-medium">
            Spread the word about DeepTech.AI 2026, complete quests, earn points, and win exclusive IEEE CS merchandise and front-row seating perks.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 max-w-4xl mx-auto mt-10">
            ...
            >
              ...
              <span className="text-sm font-bold text-ieee-black">LinkedIn</span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-bold text-ieee-black">Instagram</span>
            </a>

            {/* X / Twitter */}
            <a
              href="https://twitter.com/ieeecsbs"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <span className="text-sm font-bold text-ieee-black">X (Twitter)</span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-bold text-ieee-black">Facebook</span>
            </a>
          ...
          <div className="mt-8 bg-linear-to-r from-ieee-blue to-ieee-cyan p-6 rounded-[2rem] text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-lg">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center shrink-0">
                <Trophy className="w-7 h-7 text-white" />
              </div>
              <div className="text-left">
                <div className="text-sm font-bold opacity-80 uppercase tracking-wider">Your Score</div>
                <div className="text-3xl font-black font-heading">{userPoints} PTS</div>
              </div>
            </div>
        ...
        {activeTab === "quests" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${
                          isCompleted ? "bg-emerald-100 text-emerald-600" : "bg-ieee-orange/10 text-ieee-orange"
                        }`}>
                          {isCompleted ? <CheckCircle className="w-6 h-6" /> : <Award className="w-6 h-6" />}
                        </div>
                        <div>
                          <div className="flex items-center gap-3">
                            <h3 className="font-bold text-lg text-ieee-black leading-tight">{quest.title}</h3>
                            <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${
                              isCompleted ? "bg-emerald-200/50 text-emerald-700" : "bg-ieee-blue/15 text-ieee-blue"
                            }`}>
                              +{quest.points} PTS
                            </span>
                          </div>
              ...
              <div className="bg-white rounded-[2rem] p-8 border border-ieee-gray/10 mt-12 space-y-6">
                <div>
                  <h3 className="text-xl font-bold font-heading text-ieee-black">Claim Your Points</h3>
                  <p className="text-xs text-ieee-gray mt-1">
                    Once you make the social post, select the quest below, paste your link, and submit to verify and update the leaderboard.
                  </p>
                </div>
                ...
                <form onSubmit={handleQuestClaim} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-ieee-black uppercase tracking-wider">Select Quest</label>
                      <select
                        value={questId}
                      ...
                      >
                        {quests.map(q => (
                          <option key={q.id} value={q.id} disabled={claimedQuests.includes(q.id)}>
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-ieee-black uppercase tracking-wider">Email Address</label>
                      <input
                        type="email"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-ieee-black uppercase tracking-wider">Social Handle</label>
                      <input
                        type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-ieee-black uppercase tracking-wider">Shared Post Link / URL</label>
                    <input
                      type="url"
            ...
            <div className="lg:col-span-4 bg-white/70 backdrop-blur-xl border border-ieee-gray/10 p-6 rounded-[2.5rem] shadow-sm space-y-6">
              <div className="text-center">
                ...
                <h2 className="text-xl font-black font-heading text-ieee-black">Influencer Leaderboard</h2>
                <p className="text-xs text-ieee-gray mt-1">Live standings of top amplifiers</p>
              </div>
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-black shrink-0 ${
                          ...
                          user.rank === 3 ? "bg-orange-100 text-orange-700" : "bg-ieee-gray/10 text-ieee-gray"
                        }`}>
                          {user.rank}
                        </span>
                        ...
                        <div className="overflow-hidden">
                          <div className="font-bold text-sm text-ieee-black truncate">{user.name}</div>
                          <div className="text-xxs text-ieee-gray uppercase font-bold tracking-wider truncate">{user.badge}</div>
                        </div>
                      </div>
                      <div className="text-right shrink-0">
                        <div className="font-black text-sm text-ieee-blue">{user.points}</div>
                        <div className="text-xxs text-ieee-gray uppercase tracking-wider font-bold">Points</div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold font-heading text-ieee-black flex items-center gap-2">
                <MessageSquare className="w-5 h-5 text-ieee-cyan" /> Community Live Feed
              </h2>
              <span className="text-xs font-bold bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 px-3 py-1.5 rounded-full animate-pulse flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-emerald-500" /> Live Feed
              </span>
            </div>
            ...
            {posts.length === 0 ? (
              <div className="bg-white rounded-3xl p-16 text-center text-ieee-gray font-semibold border border-ieee-gray/10 max-w-lg mx-auto">
                ...
                <p className="text-base text-ieee-black">No verified social wall posts yet.</p>
                <p className="text-xs text-ieee-gray mt-1">Complete a quest and submit your post link to show up here!</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {posts.map((post) => {
                  const igMatch = post.postUrl?.match(/instagram\.com\/(?:p|reel)\/([A-Za-z0-9_-]+)/);
                  const igEmbedUrl = igMatch && igMatch[1] ? `https://www.instagram.com/p/${igMatch[1]}/embed` : null;

                  if (igEmbedUrl) {
                    return (
                      <div key={post.id} className="bg-white rounded-3xl overflow-hidden border border-ieee-gray/10 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="p-4 bg-ieee-gray/5 border-t border-ieee-gray/5 flex items-center justify-between text-xxs font-bold text-ieee-gray">
                          ...
                          <a href={post.postUrl} target="_blank" rel="noopener noreferrer" className="text-ieee-cyan hover:underline">
                            View Original
                          </a>
                        </div>
                      </div>
                  ...
                  return (
                    <div key={post.id} className="bg-white rounded-3xl p-6 border border-ieee-gray/10 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="overflow-hidden">
                              <div className="font-bold text-sm text-ieee-black truncate">{post.user}</div>
                              <div className="text-xs text-ieee-gray truncate">{post.handle}</div>
                            </div>
                          </div>
                          <span className={`text-xxs font-black uppercase tracking-wider px-2 py-1 rounded-full ${
                            post.platform === "linkedin" ? "bg-sky-100 text-sky-700" :
                            post.platform === "instagram" ? "bg-pink-100 text-pink-700" :
                            post.platform === "twitter" ? "bg-slate-100 text-slate-700" : "bg-blue-100 text-blue-700"
                          }`}>
                            {post.platform}
                          </span>
                        </div>
                        ...
                        {post.postUrl && (
                          <div className="pt-2">
                            ...
                            >
                              View Post on {post.platform === "linkedin" ? "LinkedIn" : "X (Twitter)"}
                            </a>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-4 mt-6 border-t border-ieee-gray/5 text-xxs font-bold text-ieee-gray">
                        ...
                        <div className="flex items-center gap-4">
                          <span className="flex items-center gap-1">
                            <Heart className="w-3.5 h-3.5 text-pink-500 fill-pink-500" /> {post.likes}
                          </span>
                          <span className="flex items-center gap-1">
                            <Share2 className="w-3.5 h-3.5 text-ieee-cyan" /> {post.shares}
                          </span>
                        </div>
                      </div>
                    </div>
